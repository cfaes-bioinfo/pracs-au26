...
subtitle: "Week 8 - lecture A"
pagetitle: "w8a: GenAI I"
date: 2026-10-12
...
to help you with tasks in omics data analysis, especially coding tasks.
...
- You are able to use them e.g. with more advanced models without usage limits
- You are complying with Ohio State's data privacy and security policies.
  When you are logged in using your OSU account, the data you provide to the AI
  tools is handled according to Ohio State's policies.
  Therefore, you are allowed to provide it with research data that you otherwise
...
![](../img/ms-copilot_trimgalore-response1.png){fig-align="center" width="80%" fig-alt="A screenshot of a Microsoft Copilot response about TrimGalore" .lightbox}
...
![](../img/ms-copilot_trimgalore-response2.png){fig-align="center" width="65%" fig-alt="A screenshot of a Microsoft Copilot response about TrimGalore" .lightbox}
...
![](../img/letter-count-unconventional.png){fig-align="center" width="80%" fig-alt="A screenshot of a Microsoft Copilot response counting letters in a word" .lightbox}

This answer is bizarre,
as it starts out with an incorrect answer and then sort of corrects itself:

![](../img/letter-count-blueberry.png){fig-align="center" width="65%" fig-alt="A screenshot of a Microsoft Copilot response counting letters in a word" .lightbox}
...
- **AI hallucinations** are a well-known problem and you've probably heard about
  ...
  - May give example code _and_ its output -- but the code may not produce that
...
- "**0-to-90% problem**" describes how generative AI can often get you most of the way
  ...
  And because it is much harder to finish the last 10% when you haven't done the
  first 90% yourself,
  this can be enormously challenging and sometimes undoes any time savings.
