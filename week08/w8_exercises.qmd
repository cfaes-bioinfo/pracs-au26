...
4. Download the FastQC output for the trimmed R1 file and compare it to the output
   ...
   [week 6 lecture on using software at OSC](../week06/w6b_software.qmd#a-practical-example-running-fastqc-on-a-fastq-file).
...
1. In the README, write and run a `for` loop that will run your TrimGalore
   ...
   _see [this section of the w7b lecture](../week07/w7b_cli-tools.qmd#looping-over-samples).)_
