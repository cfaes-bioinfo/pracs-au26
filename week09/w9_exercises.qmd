...
2. Create a dir `week09/exercises` **and navigate there** --
   this should be your working dir for the exercises
3. Create a dir `scripts` (i.e., `week09/exercises/scripts`) but don't navigate there
...
5. You'll be working with the `garrigos` FASTQ files.
   ...
   or copy these FASTQ files into a `data` dir within `week09/exercises`.
...
```bash-out
total 949M
-rw-rw----+ 1 jelmer PAS0471  20M Mar 28 11:18 S63_R1_val_1_.fastq.gz
...
-rw-rw----+ 1 jelmer PAS0471  21M Mar 28 11:18 S63_R2_val_2_.fastq.gz
...
-rw-rw----+ 1 jelmer PAS0471  21M Mar 28 11:19 S64_R1_val_1_.fastq.gz
...
-rw-rw----+ 1 jelmer PAS0471  22M Mar 28 11:19 S64_R2_val_2.fastq.gz
...
-rw-rw----+ 1 jelmer PAS0471  21M Mar 28 11:20 S65_R1_val_1_.fastq.gz
