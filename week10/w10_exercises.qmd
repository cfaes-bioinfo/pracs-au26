...
- We've already made the shell scripts to run indival steps.
  ...
  ```bash
  cp -v /fs/ess/PAS3493/share/scripts/w9_ex/* scripts/
  ```
  ```bash-out
  '/fs/ess/PAS3493/share/scripts/w9_ex/fastqc.sh' -> 'scripts/fastqc.sh'
  '/fs/ess/PAS3493/share/scripts/w9_ex/multiqc.sh' -> 'scripts/multiqc.sh'
  '/fs/ess/PAS3493/share/scripts/w9_ex/star_align.sh' -> 'scripts/star_align.sh'
  '/fs/ess/PAS3493/share/scripts/w9_ex/star_index.sh' -> 'scripts/star_index.sh'
  '/fs/ess/PAS3493/share/scripts/w9_ex/trimgalore.sh' -> 'scripts/trimgalore.sh'
  ```
...
- Expected Slurm log file contents (one file):
  ...
  # Input R2 FASTQ file:            results/trimgalore/S63_R1.fastq.gz
  ...
  INFO:    Using cached SIF image
  INFO:    gocryptfs not found, will not be able to use gocryptfs
  	/opt/conda/bin/STAR-avx2 --readFilesIn results/trimgalore/S63_R1.fastq.gz results/trimgalore/S63_R1.fastq.gz --genomeDir results/star/index --sjdbGTFfile garrigos/ref/annot.gtf --runThreadN 8 --readFilesCommand zcat --outFileNamePrefix results/star/S63_ --outSAMtype BAM SortedByCoordinate
  	STAR version: 2.7.11b   compiled: 2024-07-03T14:39:20+0000 :/opt/conda/conda-bld/star_1720017372352/work/source
