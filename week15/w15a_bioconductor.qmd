...
other-links:
  ...
  - text: "Week 14a Data Visualization"
    icon: bookmarks
    href: w14a_data-viz.html
language:
...
directory that we created on Monday as `week13b_bioconductor`.
...
- `SummarizedExperiment (SE)`: Used in RNA-seq analysis (We will discuss about it in more detail in **week15**)
