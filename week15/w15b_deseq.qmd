...
1. At <https://ondemand.osc.edu>,
   ...
   ([Starting an RStudio Server session at OSC](../week12/w12a_r-basics.html#starting-an-rstudio-server-session-at-osc)) and open your RStudio Project
...
count_table_file <- "/fs/ess/PAS3493/people/menuka/salmon.merged.gene_counts_length_scaled.tsv"
...
- Another very common type of plot used for gene expression data (and omics data
  ...
  You'll create heatmaps in [this week's exercises](./w15_exercises.qmd).
