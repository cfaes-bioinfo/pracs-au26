...
_TODO: add more info about home dir_

_TODO: show System status_

_TODO: Turn into slides !!_
...
In this and the next few weeks, you will get ready to run
command-line bioinformatics programs at OSC step by step --- we'll cover:
...
and will go a bit deeper into the following aspects of the OSC:
...
2. In the Extensions pane that now fills the Primary (wide) Side Bar,
   ...
   This extension makes CSV/TSV files easier to view with column-based colors.
...
### Self-study: Additional VS Code tips and tricks (_Click to expand_)
...
In week 2, you learned that a supercomputer center like OSC typically has
...
## OSC content ported from week 2 - TODO
