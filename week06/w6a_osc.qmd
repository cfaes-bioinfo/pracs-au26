...
Project admins can, among others:
...
: {.striped .hover tbl-colwidths="[13, 22, 16, 19, 15, 15]"}
...
| **Home**    | [500 GB / 1 M files]{.amber} | [Yes]{.teal} | [No]{.teal}             | [Slower]{.amber} | [No]{.teal}   |
| **Project** | [Flexible]{.teal}            | [Yes]{.teal} | [No]{.teal}             | [Slower]{.amber} | [Yes]{.amber} |
| **Scratch** | [100 TB]{.teal}              | [No]{.amber} | [After 60 days]{.amber} | [Faster]{.teal}  | [No]{.teal}   |
...
## For what are different storage areas useful?

::: {.columns}
::: {.column width="30%" .box-blue}
### Project

- Project-related files you want to keep long-term:
...
- Temporary storage of intermediate results and raw outputs for analyses
  of large datasets.
...
- Files you use across projects, like some software.
- Experimentation outside of specific projects.
...
all of which is **free and open-source**.
...
Rolling out clusters this way is for example beneficial because it keeps some\
