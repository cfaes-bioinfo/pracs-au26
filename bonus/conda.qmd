...
```bash
# [Don't run this]
conda create -y -p /fs/scratch/PAS3493/$USER/conda/trim-galore bioconda::trim-galore
```
...
::: exercise
#### {{< fa user-edit >}} Exercise: Create a Nextflow + nf-core environment

Later in the course, you'll work with Nextflow and the affiliated community
project nf-core, which are typically used together.
As practice, create a single Conda environment with both Nextflow and the
nf-core tools installed into it.
