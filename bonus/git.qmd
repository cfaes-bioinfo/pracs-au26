...
```bash
mkdir /fs/ess/PAS3493/users/$USER/week03/fork_test
cd /fs/ess/PAS3493/users/$USER/week03/fork_test
```
...
```
```bash-out
Initialized empty Git repository in /fs/ess/PAS3493/users/jelmer/CSB/git/sandbox/branching_example/.git/
...
```sh
cd /fs/ess/PAS3493/users/$USER/CSB/git/sandbox
```
</details>
