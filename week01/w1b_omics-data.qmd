...
- An idea of what **reference genomes** are and what they are good for
...
**Sanger sequencing (since [1977]{.teal})**\
...
**High-throughput sequencing (HTS, since [2005]{.teal})**\
...
For example, if you work with maize, you will want a _Zea mays_ reference genome.
But:
...
- An overview of the data processing and analysis steps we will perform on the Garrigós dataset
...
# Bonus slides {background-color="#A7B1B7"}
