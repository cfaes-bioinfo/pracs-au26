...
**[HTS]{style="color:#00A087FF"}** and the data it produces are the focus of the rest of
...
- Clustering/ordination (e.g., PCA) and network analyses
...
HTS produces the two most prevalent omics data types:
...
::: {.column width="4%"}
:::
::: {.column width="29%" .box-secondary}

Three HTS technologies are most commonly used,
and these produce reads that are:
...
::: {.column width="4%"}
:::
::: {.column width="29%" .box-primary}

_Many_ different applications exist.

Some of these are not just about determining the exact DNA sequence.
