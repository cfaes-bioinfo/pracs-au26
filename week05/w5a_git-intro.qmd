---
title: "Version control:<br>Why and how"
...
<!----
Start of lecture:
- Discuss Excel and Word usefulness?
- How is the pace so far: too fast, too slow, about right?
--->
...
::: callout-tip
#### Answer
**a)** and **d)**: these are files you edit by hand.
**b)** and **e)** are derived files: you can always regenerate them from the script
...
- We'll also briefly demonstrate the **VS Code integration**,
...
- An online counterpart of a local repo is called a
  "remote repository" or simply a "**remote**".
...
![](../img/git-remote-3.png){fig-align="center" width="80%" fig-alt="A diagram of a local repo with one more commit than its GitHub remote." .lightbox}

::: legend2
Boxes are commits and the `4dce25f`-type labels are commit IDs ("hashes").
After making a new commit locally, your local and remote repos are out of sync:
the local repo has one more commit than the GitHub remote.
:::
...
![](../img/git-remote-4.png){fig-align="center" width="80%" fig-alt="A diagram showing git push uploading the new local commit to GitHub." .lightbox}

::: legend2
`git push` uploads the new commit, after which the repos are back in sync.
:::
