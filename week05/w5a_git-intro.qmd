...
Over the course of a research project, your files will change a lot.
Ideally, you'd keep earlier versions of your files, see what changed between them,
and be able to go back --- for example, after accidentally overwriting a file,
or when a script that used to work no longer does.

Modern cloud storage solutions (OneDrive, Dropbox, etc.) help with some of this:
...
- You can easily see and undo changes that AI coding assistants made to your code.
