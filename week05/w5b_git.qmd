...
like always, you can decide what to write, but the idea is that it should be a
short description of the changes you made:
...
::: exercise
#### {{< fa user-edit >}} Exercise 2: Find the mistake
...
::: exercise
#### {{< fa user-edit >}} Exercise 4: Another change and commit
...
::: exercise
#### {{< fa user-edit >}} Exercise 5: `.gitignore`

1. In another project, someone wanted Git to ignore both the `data` dir
...
2. Say that a repo's `.gitignore` file contains these two lines:
...
3. Say that you add the line `todo.txt` to the `.gitignore` file of your `originspecies` repo,
...
### "Working dir" in the context of Git _(Click to expand)_
When we talk about the "working dir" in the context of Git,
...
::: exercise
#### {{< fa user-edit >}} Exercise 6: File states
...
- The **working dir** and the **last commit**, if you haven't staged the file.
- The **working dir** and the **stage (Index)**, if you have staged the file
...
We'll practice undoing changes to your working dir (that have not been staged)
...
::: exercise
#### {{< fa user-edit >}} Exercise 7: What can Git restore?
