...
![](/img/vscode-recents.png){fig-align="center" width="90%" fig-alt="A screenshot of the VS Code 'Get Started' document, showing the 'Recents' section." .lightbox}

::: legend2
The Welcome page in VS Code, showing "**Recent**":
