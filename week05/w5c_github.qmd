...
::: {.callout-warning appearance="simple"}
If you do use the HTTPS URL by mistake, `git push` will ask for your GitHub
user name and password, and then fail even if you enter them correctly.
Don't fix this by running `git remote add` again
(you'd get "`error: remote origin already exists`"),
but change the URL with `git remote set-url` ([see below](#check-remote)).
:::
...
::: exercise
#### {{< fa user-edit >}} Self-study exercise: Commit and push
