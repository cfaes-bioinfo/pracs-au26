...
- Open the `week05/evo` dir you created last class.
  ...
  <details><summary> {{< fa lightbulb >}} _Or: opening the folder manually (Click to expand)_</summary>
...
![](../img/github-markdown-rendered.png){fig-align="center" width="90%" .no-border fig-alt="A screenshot of the rendered README file on GitHub." .lightbox}
