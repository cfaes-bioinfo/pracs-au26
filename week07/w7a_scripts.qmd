...
As such, the `printname.sh` file with a single `echo` command
...
# [Paste this into your script - don't enter this directly in your terminal.]
```
...
- _To get back to where you were,_
  _remove the `#` you inserted in the script in step 2 above to reactivate the `set` line._
:::
