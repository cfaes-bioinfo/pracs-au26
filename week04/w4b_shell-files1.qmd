...
and pressing <kbd>Tab</kbd> after each `../` will show you
where you are, so you can check you've gone up enough levels.
:::
...
```
```{=html}
<pre class="bash-out"><code><span style="color: #0328fc;">butterflies</span>  <span style="color: #0328fc;">meta</span>  meta2.tsv  metadata.tsv  newfile1.txt  newfile2.txt<br>newfile3_copy.txt  newfile3.txt  <span style="color: #0328fc;">testdir1</span>  <span style="color: #0328fc;">testdir2</span>  <span style="color: #0328fc;">testdir3</span></code></pre>
```
