...
- ***Search***: To search (and replace) across all files in the active folder
...
### Additional VS Code tips and tricks _(Click to expand)_
...
Then, it may not always be convenient to list an entire dir's contents.
...
```
```bash-out
butterflies  meta  meta2.tsv  metadata.tsv  newfile1.txt  newfile2.txt
newfile3.txt  newfile3_copy.txt  testdir1  testdir2  testdir3
```
...
remove one of the files you created above:
