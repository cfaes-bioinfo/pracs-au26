...
![](../img/script_file.png){fig-align="center" width="80%"}
...
- How to use RStudio Projects to keep your work organized and reproducible,
  and R scripts to document your workflow for future use

In the next lecture, you'll learn about R's data structures and data types,
