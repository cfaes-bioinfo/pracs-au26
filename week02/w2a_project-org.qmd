...
<!-----
TODO for next year:
- Mention constraints/predefined routines in a lab (by a PI)
---->
...
A) The FASTQ files you got back from the sequencing facility.
B) A figure you made for a paper.
C) The code you wrote to make that figure.
D) A spreadsheet listing your sample IDs and collection dates.
...
<details class="details-quiz"><summary>Can you see **two ordering problems** with this format?</summary>
...
<details class="details-quiz"><summary>Can you think of **two benefits** of using four digits for the year?</summary>
...
Use **leading zeros** in file names --- for example, `sample05` instead of `sample5`.
...
What 2–4 problems does this file name have?<br>
...
writing/reading and formatting options. More on Markdown later this week!
:::
