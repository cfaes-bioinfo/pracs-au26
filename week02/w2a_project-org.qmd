...
this week's reading.
We'll briefly get back to that paper next week in class.
...
2. Never edit your raw data, and avoid editing your results manually.
...
- _All_ files related to that project,\
  and _only_ those files
...
Use what works for you while keeping in mind these principles,
...
B) A spreadsheet listing your sample IDs and collection dates
...
A) `data` (e.g., `data/seqs`)
B) `data` (e.g., `data/meta`)
C) `results`
D) `scripts`
...
![](../img/proj-ex-annot_2025_crop.png){fig-align="center" width="90%" fig-alt="A screenshot showing an example research project folder hierarchy."}
...
If you are entering data piecemeal e.g. during a longer experiment,
consider using separate files for each batch of data.
At the very least, don't combine directly entered data with data analysis
or visualization in a single spreadsheet ---
the less you touch the raw data files, the better.
:::

## 2b. Avoid manually editing results

**Avoid manually editing files with (intermediate) results** ---
...
- Can be easily repeated if needed. Recall @noble2009:
  "_Everything you do, you will probably have to do over again._"
...
### [Raw data]{style="display:block; text-align:center;"}
...
### [Results]{style="display:block; text-align:center;"}
...
::: {.callout-tip appearance="simple"}
There is some nuance here, as some results may take _many_ hours to regenerate.
:::
...
<details class="details-quiz"><summary>What problems are you seeing?</summary>
...
<details class="details-quiz"><summary>Why use four digits for the year?</summary>
...
How many problems can you find in this file name?<br>
...
- **`May 3 2016`** --- doesn't sort correctly; use `2016-05-03`

Additionally:

- **"Final"** and especially **"(2)"** say nothing about the content,
  and keeping versions this way is what version control is for (week 5)
...
Some examples of possible **alternatives** to consider:
