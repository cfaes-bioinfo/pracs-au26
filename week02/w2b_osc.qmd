...
- You'll learn much more along the way, and a deeper dive will follow in week 5.
...
- how to access these through its web portal, "OSC OnDemand".
...
## File system -- first some background
...
<details class="details-quiz">
<summary>What is the path to this personal folder of Jane's?</summary>
...
- Your Home location may be elsewhere:
  this project is merely the first one `jane` joined when her account was created.
...
2. Click the "New Directory" at the top.
   [( {{< fa lightbulb >}} _Directory, or "dir" for short, is another word for folder._)]{.teal}
...
::: {style="color:#6f42c1;"}
{{< fa user-edit >}} _Go ahead and click on **Code Server**,_
_and we'll continue from there in the next session to get introduced to it._
:::
