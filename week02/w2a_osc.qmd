...
![A diagram showing the key dirs on OSC for this course, with OSC Project-associated dirs in blue and Home dirs in red. The `PAS3493` box in the Home dir is faded, because your Home dir may be in a differently named dir, and also because it is important to realize that this dir is not associated with any OSC Project other than in name.](../img/osc-paths2.png){fig-align="center" width="40%" .lightbox fig-alt="A diagram showing paths on OSC and navigating upwards with relative paths"}
