...
![](../img/osc-paths3.png){fig-align="center" width="100%" fig-alt="A diagram showing paths on OSC and navigating upwards with relative paths"}
...
![](../img/osc-paths4.png){fig-align="center" width="100%" fig-alt="A diagram showing paths on OSC and navigating upwards with relative paths"}
...
- Recall: you'll only ever have one Home folder at OSC.
