...
![](/img/osc_cluster-diagram.png){fig-align="center" width="100%" fig-alt="A diagram showing the structure of a supercomputer center with three main components:file systems, login nodes, and compute nodes"}
...
![A screenshot of the "System Status" page showing live cluster usage.](../img/ondemand_systemstatus.png){fig-align="center" width="75%" fig-alt="A screenshot of the OSC Ondemand System Status page showing live cluster usage." .lightbox}
