---
title: "Ungraded Assignment 4:<br>Local VS Code installation"
subtitle: "Week 7 (deadline: Sunday Oct 12)"
pagetitle: "Week 7 Ungraded Assignment"
...
other-links:
  - text: "Optional self-study: SSH connections"
    icon: book
    href: ../bonus/ssh.html
language:
...
Please complete this assignment by noon on Sunday, October 11^th^.
We will start using this functionality in class on Monday, October 12^th^. 
:::
...
4. Like you've seen with VS Code Server, the program's default location is your Home dir,
   ...
   go to your `/fs/ess/PAS3493/people/$USER` dir.
...
2. Open it again, and under "Recents" on the Welcome tab,
   look for your folder in `/fs/ess/PAS3493/`,
